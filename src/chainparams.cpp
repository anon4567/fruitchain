...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.scriptPubKey = genesisOutputScript;
    //genesis.vtx.push_back(txNew);
    genesis.hashPrevEpisode.SetNull();
...
public:
    CMainParams()
    {
        ...
        // TODO: assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        // TODO: assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.BIP66Height = 330776; // 000000002104c8c45e99a8853285a3b592602a3ccde2b832481da85e9e4ba182
                                        //        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        //verFruit
        /** if powlimit is too small, fruit difficulty will be equal to block difficulty,
         *  and may be not able to get fruit
        **/
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); //uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 6*60; //14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 60; //10 * 60;
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: assert(consensus.hashGenesisBlock == uint256S("0x000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943"));
        // TODO: assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of(546, uint256S("000000002a936ca763904c3c35fce2f3556c559c0214345d31b1bcebf76acb70")),
            1337966069,
            1488,
            300};
    }
...
public:
    CRegTestParams()
    {
        ...
        consensus.nPowTargetTimespan = 6; //14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 3;
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x0000ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: assert(consensus.hashGenesisBlock == uint256S("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
        // TODO: assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
