...
/** Maximum portion shared to collector : 1/FRUIT_MAX_TAX **/
static const unsigned int FRUIT_MAX_TAX = 2;
/** Length of fruit period */
static const unsigned int FRUIT_PERIOD_LENGTH = 8;
/** Length of distribution period */
static const unsigned int REWARD_PERIOD_LENGTH = FRUIT_PERIOD_LENGTH * 2;
...
static const int REWARD_CREATE_FRACTION_C2_NUMERATOR = 1;
static const int REWARD_CREATE_FRACTION_C2_DENOMINATOR = 10;
...
/** In Fruitchain it should be disabled */
...
public:
    ...
    CScriptCheck(const CCoins& txFromIn, const CTransaction& txToIn, unsigned int nInIn, unsigned int nFlagsIn, bool cacheIn, PrecomputedTransactionData* txdataIn) : scriptPubKey(txFromIn.vout[txToIn.vin[nInIn].prevout.n].scriptPubKey), amount(txFromIn.vout[txToIn.vin[nInIn].prevout.n].nValue),
...
bool DisconnectBlock(const CBlock& block, CValidationState& state, const CBlockIndex* pindex, CCoinsViewCache& coins, const CChainParams& chainparams, bool* pfClean = NULL);
