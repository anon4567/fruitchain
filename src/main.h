...
//verFruit
bool AcceptFrtToMemoryPool(CFrtMemPool& pool, CValidationState &state, const CFruit &frt, //bool fLimitFree,
                 /*bool* pfMissingInputs,*/ bool fOverrideFrtMempoolLimit=false/*, const CAmount nAbsurdFee=0*/);
